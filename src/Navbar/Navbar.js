...
import Password from "../Login/restarpassword";
import Chatbox from "../chat/Chatbox";
import Home from "../Home/Home";
import Service from "../service/service";
import Reserve from "../reserve/reserve";
import Account from "../account/account";
import Liste from "../stock/listeproduitclient";
      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        >
          ...
          >
            ...
            <Menu.Item key="/" icon={<DingdingOutlined />}>
              <Link to="/"> Acceuil</Link>
            </Menu.Item>
            <Menu.Item key="/Service" icon={<ToolOutlined />}>
              <Link to="/Service"> Service</Link>
            </Menu.Item>
            <Menu.Item key="/Listeproduit" icon={<ToolOutlined />}>
              <Link to="/Listeproduit">Produit</Link>
            </Menu.Item>
            ...
            <Menu.Item key="/Reserve" icon={<CarryOutOutlined />}>
        ...
        <Layout className="site-layout">
          <div className="image">
            <Image width={"100%"} src="/images/135545-142056-navbar1.png" />
          </div>
          <div className="mes">
            {user && user.role_as === "user" ? <Chatbox /> : null}
          </div>
          <UncontrolledDropdown className="accounticone">
            ...
            <DropdownMenu right>
              ...
              {!user ? (
                <DropdownItem href="/login">Connexion</DropdownItem>
              ) : (
            ...
            <SwitchTransition>
              ...
              >
                <Routes location={location}>
                  <Route path="/verif/:id" element={<VerifCompte/>} />
                  <Route exact path="/" element={<Home/>} />
                  <Route exact path="/Service" element={<Service/>} />
                  <Route exact path="/Contact" element={<Contact/>} />
                  <Route exact path="/About" element={<About/>} />
                  <Route path="/Account" element={<Account/>} />
                  <Route exact path="/Listeproduit" element={<Liste/>} />
                  <Route exact path="/login" element={<Login/>} />
                  <Route path="/restarpassword/:id" element={<Password/>} />
