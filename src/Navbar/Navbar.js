    ...
    return (
      ...
      <Layout style={{ minHeight: '100vh' }}>
        <Sider collapsible className="l1" collapsed={widthw < 1350 ?  true :collapsed} onCollapse={widthw < 1350 ?  null :onCollapse} >
          <Menu  defaultSelectedKeys={[location.pathname]} mode="inline" style={{position: "fixed",width: widthw < 1350 ?  "" :width }}>
      ...
      <div className="mes">{user && user.role_as==="user"?<Chatbox/>:null}</div>
              ...
              <DropdownItem ><Link to="/">
               ...
               :<></>}
                ...
                {!user ? <DropdownItem href="/login">  
                  Connexion
                </DropdownItem>: <DropdownItem href="/login">  
                  Déconnexion
                </DropdownItem>}
              </DropdownMenu>
