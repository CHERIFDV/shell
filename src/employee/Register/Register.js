  ...
  return (
    ...
    <Formik
      ...
      onSubmit={(value,{resetForm})=>{
        ...
        axios.post('../api/personnel/register',{nom:value.firstName,prenom:value.lastName,cin:value.cin,tel:value.tel,email:value.username,password:value.Password,city:value.city,state:value.state,zip:value.zip})
      .then(response => { 
        setloading(false)
       resetForm({values:""})
